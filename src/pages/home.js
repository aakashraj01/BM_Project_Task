    ...
    return (
        <div className='home'>
            ...
            <div className='bill-footer'>
                <Button variant='primary' onClick={handleShow}>Add New bill</Button>
            </div>
            ...
            <span className='h3' style={{color:'white',position:"absolute",bottom:10,right:10,fontWeight:300}} >Total bill Amount: Rs {totalBill}</span>
        </div>
    );
}
